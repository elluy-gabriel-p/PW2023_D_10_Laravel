                        ...
                        <div class="input-group">
                            ...
                            <div class="form-floating text-muted">
                                <input type="number" class="form-control" id="InputPhone1" name="no_telp"
                                    placeholder="Masukkan No Telepon" value="{{ old('no_telp', $profile->no_telp) }}"
                                    required />
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-floating text-muted">
                                <input type="password" class="form-control" id="InputPassword1" name="password"
                                    placeholder="Masukkan Password" value="{{ old('password', $profile->password) }}"
                                    required />
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-floating text-muted">
                                <input type="number" class="form-control" id="InputUmur1" name="umur"
                                    placeholder="Masukkan Umur" value="{{ old('umur', $profile->umur) }}" required />
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-floating text-muted">
                                <input type="file" class="form-control" id="InputFoto1" name="image"
                                    placeholder="Masukkan Foto Profile" value="{{ old('image', $profile->image) }}"
                                    required />
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-floating text-muted">
                                <input type="text" class="form-control" id="InputNama1" name="name"
                                    placeholder="Masukkan nama" value="{{ old('name', $profile->name) }}" required />
                                <label for="InputPassword1" class="form-label" style="font-weight: bold">Nama</label>
                            </div>
                        </div>
                    </div>
                    <div class="button-container">
                        <a href="{{ url('profile') }}" type="button" class="btn btn-danger"><i
