...
<body>
    ...
    <div class="isi">
        ...
        <div class="wrapper">
            <div class="form-box login">
                <h1>Login</h1>
                <form class="row g-3 needs-validation" novalidate action="{{ route('actionLogin') }}" method="POST">
                    @csrf
                    ...
                    <div class="punyaAkun">
                        <p class="mb-0">Tidak Punya Akun ?
                            ...
                            <br>
                            <a href="{{ route('adminLogin') }}" class="forgot-password">Admin</a>
                        </p>
    ...
    <script>
        const password = document.querySelector("#passworrd");
